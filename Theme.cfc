...
component{
	...
	this.settings = [
		...
		{
			name         : "showFacebookOnTop",
			group        : "Social Options",
			defaultValue : "",
			type         : "text",
			label        : "Show Facebook icon in social media options",
			required     : "false"
		},
		{
			name         : "showTwitterOnTop",
			group        : "Social Options",
			defaultValue : "",
			type         : "text",
			label        : "Show Twitter icon in social media options",
			required     : "false"
		},
		{
			name         : "showGoogleOnTop",
			group        : "Social Options",
			defaultValue : "",
			type         : "text",
			label        : "Show Google Plus icon in social media options",
			required     : "false"
		},
		{
			name         : "showLinkedinOnTop",
			group        : "Social Options",
			defaultValue : "",
			type         : "text",
			label        : "Show Linkedin icon in social media options",
			required     : "false"
		},
		{
			name         : "showBehanceOnTop",
			group        : "Social Options",
			defaultValue : "",
			type         : "text",
			label        : "Show Behance icon in social media options",
			required     : "false"
		},
		{
			name         : "showVimeoOnTop",
			...
			defaultValue : "",
			type         : "text",
			label        : "Show Vimeo icon in social media options",
			required     : "false"
		},
		{
			name         : "showYoutubeOnTop",
			group        : "Social Options",
			defaultValue : "",
			type         : "text",
			label        : "Show Youtube icon in social media options",
			required     : "false"
		},
		{
			name         : "addThisURL",
			...
			defaultValue : "",
			type         : "text",
			label        : "AddThis Social Plugin API KEYs",
			required     : "false"
		},
		{
			name         : "singleBlogOptions",
			group        : "Social Options",
			defaultValue : "",
			type         : "text",
			label        : "Show Options in Single Blog",
			required     : "false"
		},
		{
			name         : "showBannerImg",
		...
		{
			name         : "showBannerHeading",
			group        : "Banner",
			defaultValue : "",
			type         : "text",
			label        : "Enter Banner Heading"
		},
		{
			name         : "showBannerContent",
			group        : "Banner",
			defaultValue : "",
			type         : "text",
			label        : "Enter Banner Content"
		},
		{
			name         : "showBannerURL",
			group        : "Banner",
			defaultValue : "",
			type         : "text",
			label        : "Enter Banner URL on Button"
		},
		{
			name         : "showSideBarImg",
			group        : "Banner",
